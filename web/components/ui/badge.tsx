...
const badgeVariants = cva(
  "inline-flex w-fit shrink-0 items-center justify-center rounded-full border px-2.5 py-1 font-mono text-[0.6875rem] leading-none font-medium whitespace-nowrap",
  {
    variants: {
      variant: {
